/* ============================================================
       ...
       This script is copied verbatim from the original EyeWrite project.
       It implements text editing, hover-based clicking, keyboard
       construction, speech synthesis, saving and instructions modal.
       Please do not modify this file; changes should be made in a
       separate driver if integration is required.
 ============================================================ */
...
document.execCommand("underline");
      ...
      setInterval(() => localStorage.setItem("textData", textBox.innerHTML), 
5000);
      ...
      registerHoverables();
      new MutationObserver(registerHoverables).observe(document.body, { 
childList: true, subtree: true });
      ...
      function keyAction(k) {
        ...
        switch (k) {
          ...
          case "Shift": shiftOn = true; setTimeout(() => (shiftOn = false), 
800); break;
...
2},height=${screen.availHeight},left=${screen.availWidth / 2},top=0`);
